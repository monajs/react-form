    ...
    function FormItemComponent(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "subscibeHandler", function () {
        ...
        var _this$state = _this.state,
            curValueStatus = _this$state.curValueStatus,
            value = _this$state.value;
        var compValue = _this.value; // if last step value change from props change

        if (curValueStatus === 'propsChange') {
          compValue = value;
        }

        _this.reportHandler(_this.bn, compValue);
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "reset", function () {
        ...
        _this.setState({
          key: Date.now(),
          value: value // store original prop of value
      ...
      _this.verifyMsg = verifyMsg || config.verifyMsg; // sync store component value
      ...
      _this.state = {
        ...
        curValueStatus: 'init',
        value: _value // store value from props
