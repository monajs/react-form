...
var withFormContext = function withFormContext(WrappedComponent) {
  ...
  /*#__PURE__*/
  function (_Component) {
    (0, _inherits2["default"])(ResComponent, _Component);

    function ResComponent(props) {
      var _this;

      (0, _classCallCheck2["default"])(this, ResComponent);
      _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ResComponent).call(this, props));
    ...
    (0, _createClass2["default"])(ResComponent, [{
      ...
      value: function render() {
        ...
        return _react["default"].createElement(_context.FormDataContext.Consumer, null, function (_ref) {
          ...
          subscibeReport(_this2.bn, _this2);
