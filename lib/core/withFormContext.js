  ...
  function (_Component) {
    ...
    function FormItemComponent(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "devWarning", function () {
        ...
        if (_this.verify && _this.verifyMsg === undefined) {
        ...
        if (_this.verify === undefined && _this.verifyMsg) {
        ...
        if (_this.verify !== undefined && !(0, _util.isBoolean)(_this.verify) && !(0, _util.isFunction)(_this.verify) && !(0, _util.isRegExp)(_this.verify)) {
          _util.log.warn('The prop `verify` only support three formats （Boolean | Function | Regular）,please check it.');
        }
      });
    ...
    _createClass(FormItemComponent, [{
      ...
      value: function render() {
        ...
        var _this$props2 = this.props,
            ...
            other = _objectWithoutProperties(_this$props2, ["bn", "value", "onChange", "verify", "verifyMsg"]);
        /* eslint-disable no-unused-vars */
